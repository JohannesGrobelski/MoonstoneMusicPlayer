...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String RADIO_COLUMN_RADIO_NAME= "Name";
    public static final String RADIO_COLUMN_RADIO_URI= "Uri";
    ...
    private static final String SQL_CREATE_TABLE_PLAYLIST =
        "CREATE TABLE " + TABLE_PLAYLIST_LIST +
            ...
            PLAYLIST_COLUMN_SONG_ID + " INTEGER)";

    private static final String SQL_CREATE_TABLE_FAVORITES =
            "CREATE TABLE " + TABLE_FAVORITE_LIST +
                    "(" + FAVORITE_COLUMN_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
                    FAVORITE_COLUMN_SONG_ID + " INTEGER)";

    private static final String SQL_CREATE_TABLE_RADIOS =
            "CREATE TABLE " + TABLE_RADIO_LIST +
                    "(" + RADIO_COLUMN_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
                    RADIO_COLUMN_RADIO_NAME + " TEXT NOT NULL,"+
                    RADIO_COLUMN_RADIO_URI + " EXT NOT NULL)";
    ...
    private static final String SQL_DROP_FOLDER_TABLE = "DROP TABLE IF EXISTS "+TABLE_FOLDER_LIST;
    private static final String SQL_DROP_PLAYLIST_TABLE = "DROP TABLE IF EXISTS "+TABLE_PLAYLIST_LIST;
    private static final String SQL_DROP_FAVORITE_TABLE = "DROP TABLE IF EXISTS "+TABLE_FAVORITE_LIST;
    private static final String SQL_DROP_RADIO_TABLE = "DROP TABLE IF EXISTS "+TABLE_RADIO_LIST;
    ...
    public void onCreate(SQLiteDatabase db) {
        try {
            ...
            db.execSQL(SQL_CREATE_TABLE_RADIOS);
